...
export const API_ENDPOINTS = Object.freeze({
  auth: Object.freeze({ login: '/auth/login', me: '/auth/me', logout: '/auth/logout', forgotPassword: '/auth/forgot-password', resetPassword: '/auth/reset-password' }),
  invitations: Object.freeze({ inspect: '/invitations/inspect', accept: '/invitations/accept', reject: null }),
  workspaces: '/workspaces',
  dashboard: Object.freeze({ summary: '/dashboard/summary', metrics: '/dashboard/metrics' }),
  campaigns: '/campaigns',
  channels: '/channels',
  audience: '/audience',
  creative: '/creative',
